...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gold-gradient": "linear-gradient(135deg, hsl(43 96% 56%), hsl(48 100% 55%))",
        "glass": "linear-gradient(135deg, hsl(220 14% 10% / 0.8), hsl(220 14% 6% / 0.9))",
      },
    },
  },
